...
[Learn more](https://flowbite.com/docs/components/timeline/#) 2. March 2022
...
Get access to over 20+ pages including a dashboard layout, charts, kanban board, calendar, and pre-order E-commerce & Marketing pages.
[Download ZIP](https://flowbite.com/docs/components/timeline/#) 2. ### Flowbite Figma v1.3.0
  ...
  <li class="mb-10 ms-6">
    ...
    >
      ...
      <div class="text-sm font-normal text-gray-500 dark:text-gray-300">
        ...
        to
        <span
          class="bg-gray-100 text-gray-800 text-xs font-normal me-2 px-2.5 py-0.5 rounded-sm dark:bg-gray-600 dark:text-gray-300"
          >Funny Group</span
        >
      </div>
    </div>
  ...
  <li class="mb-10 ms-6">
    ...
    >
      ...
      >
        ...
        to best measure your design system! This is the second session of our
        new webinar series on #DesignSystems discussions where we'll be speaking
        about Measurement.
      </div>
    </div>
  </li>
