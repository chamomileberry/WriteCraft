...
test('Import World Anvil ZIP file', async ({ page }) => {
  ...
  await fileInput.setInputFiles('./attached_assets/World-The Green Tide-2025-10-06_1759784760300.zip');
  ...
  await expect(page.getByText('Import started', { exact: false })).toBeVisible({ timeout: 10000 });
