...
const SAFE_ERROR_MESSAGES: Record<string, string> = {
  ...
  subscription: 'Subscription operation failed. Please try again or contact support.',

  // AI/External services
  aiGeneration: 'AI generation service is temporarily unavailable. Please try again.',
...
export function sanitizeError(
  ...
  if (lowerMessage.includes('payment') || lowerMessage.includes('stripe') || lowerMessage.includes('charge')) {
    return {
      error: 'Payment Error',
  ...
  if (lowerMessage.includes('ai') || lowerMessage.includes('generation') || lowerMessage.includes('quota')) {
    return {
