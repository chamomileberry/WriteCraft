...
export const characterSchemaConfig: ContentTypeConfig = {
  ...
  fieldHints: {
    ...
    givenName: {
      ...
      order: 2,
      label: "Given Name",
      placeholder: "Their first name at birth",
    },
    familyName: {
      tab: "basic",
      order: 3,
...
export const schemaDrivenConfigs: Record<string, () => ContentTypeFormConfig> =
  {
    ...
    species: () =>
      buildConfig(schemas.insertSpeciesSchema, {
    ...
    ethnicity: () =>
      buildConfig(schemas.insertEthnicitySchema, {
    ...
    culture: () =>
      buildConfig(schemas.insertCultureSchema, {
    ...
    document: () =>
      buildConfig(schemas.insertDocumentSchema, {
    ...
    food: () =>
      buildConfig(schemas.insertFoodSchema, {
        title: "Food Editor",
    ...
    drink: () =>
      buildConfig(schemas.insertDrinkSchema, {
        title: "Drink Editor",
    ...
    rank: () =>
      buildConfig(schemas.insertRankSchema, {
        title: "Rank Editor",
    ...
    condition: () =>
      buildConfig(schemas.insertConditionSchema, {
    ...
    profession: () =>
      buildConfig(schemas.insertProfessionSchema, {
        ...
        fieldHints: {
          ...
          trainingRequired: {
            tab: "requirements",
            order: 2,
            placeholder: "What training is needed?",
          },
          apprenticeship: {
            tab: "requirements",
            order: 3,
            placeholder: "Apprenticeship details",
          },
          physicalDemands: {
            tab: "requirements",
            order: 4,
          ...
          careerProgression: {
            tab: "career",
            order: 2,
            placeholder: "How do they advance?",
          },
          relatedProfessions: {
            tab: "career",
            order: 3,
            placeholder: "Add related professions...",
          },
          guildsOrganizations: {
            tab: "career",
            order: 4,
            label: "Guilds & Organizations",
            placeholder: "Add associated groups...",
          },
          historicalContext: {
            tab: "career",
            order: 5,
    ...
    potion: () =>
      buildConfig(schemas.insertPotionSchema, {
    ...
    law: () =>
      buildConfig(schemas.insertLawSchema, {
        title: "Law Creator",
        ...
        fieldHints: {
          ...
          jurisdiction: {
            ...
            multiple: false,
            placeholder: "Where does this law apply?",
          },
          description: { tab: "basic", order: 5, rows: 4 },
          genre: { tab: "basic", order: 6 },
          ...
          text: {
            ...
            label: "Law Text",
            rows: 4,
            placeholder: "The actual text of the law...",
          },
          penalties: {
            tab: "details",
            order: 2,
            rows: 3,
            placeholder: "Punishments for breaking this law...",
          },
          enforcement: {
            tab: "details",
            order: 3,
            placeholder: "Who enforces this law?",
          },
          exceptions: {
            tab: "details",
            order: 4,
            rows: 3,
            placeholder: "Any exceptions to this law...",
          },
          ...
          creator: {
            ...
            multiple: false,
            placeholder: "Who created this law?",
          },
          dateEnacted: {
            tab: "context",
            order: 2,
            label: "Date Enacted",
            placeholder: "When was this law created?",
          },
          precedent: {
            tab: "context",
            order: 3,
          ...
          relatedLaws: {
            tab: "context",
            order: 4,
            placeholder: "Add related laws...",
          },
          controversy: {
            tab: "context",
            order: 5,
            rows: 3,
            placeholder: "Any controversy around this law?",
          },
        },
      }),

    policy: () =>
      buildConfig(schemas.insertPolicySchema, {
        ...
        fieldHints: {
          ...
          organization: {
            ...
            multiple: false,
            placeholder: "Governing organization...",
          },
          description: { tab: "basic", order: 5, rows: 4 },
          genre: { tab: "basic", order: 6 },
          ...
          objectives: {
            ...
            order: 1,
            rows: 3,
            placeholder: "What does this policy aim to achieve?",
          },
          guidelines: {
            tab: "implementation",
            order: 2,
          ...
          scope: {
            tab: "implementation",
            order: 3,
            placeholder: "Who does this policy affect?",
          },
          budget: {
            tab: "implementation",
            order: 4,
            placeholder: "Cost and funding",
          },
          ...
          dateImplemented: {
            ...
            placeholder: "When was this implemented?",
          },
          review: {
            tab: "governance",
            order: 3,
            label: "Review Process",
            placeholder: "How is this policy reviewed?",
          },
          publicOpinion: {
            tab: "governance",
            order: 4,
            ...
            rows: 3,
            placeholder: "How do people view this policy?",
          },
          effectiveness: {
            tab: "governance",
            order: 5,
            placeholder: "How effective is this policy?",
          },
        },
      }),

    ceremony: () =>
      buildConfig(schemas.insertCeremonySchema, {
        ...
        fieldHints: {
          ...
          purpose: {
            ...
            order: 4,
            rows: 3,
            placeholder: "What is the purpose of this ceremony?",
          },
          description: { tab: "basic", order: 5, rows: 4 },
          genre: { tab: "basic", order: 6 },
          ...
          frequency: {
            tab: "details",
            order: 6,
            placeholder: "How often is it performed?",
          },

          traditions: {
            tab: "cultural",
            order: 1,
            placeholder: "Ceremonial traditions...",
          },
          symbolism: {
            tab: "cultural",
            order: 2,
            placeholder: "Symbolic meanings...",
          },
          requiredItems: {
            tab: "cultural",
            order: 3,
            label: "Required Items",
            placeholder: "Items needed for the ceremony...",
          },
          dress: {
            tab: "cultural",
            order: 4,
            label: "Attire",
            placeholder: "What do participants wear?",
          },
          music: {
            tab: "cultural",
            order: 5,
          ...
          food: {
            ...
            endpoint: "/api/food",
            multiple: true,
            placeholder: "Foods served...",
          },
          gifts: {
            tab: "cultural",
            order: 7,
            placeholder: "Gifts exchanged...",
          },
          significance: {
            tab: "cultural",
            order: 8,
          ...
          restrictions: {
            tab: "cultural",
            order: 9,
            placeholder: "Who cannot attend or participate?",
          },
          variations: {
            tab: "cultural",
            order: 10,
            rows: 3,
            placeholder: "Regional or cultural variations...",
          },
        },
      }),

    music: () =>
      buildConfig(schemas.insertMusicSchema, {
        ...
        fieldHints: {
          ...
          vocals: {
            tab: "composition",
            order: 3,
            placeholder: "Solo, chorus, none...",
          },
          lyrics: {
            tab: "composition",
            order: 4,
            rows: 6,
            placeholder: "Song lyrics (if any)...",
          },
          tempo: {
            tab: "composition",
            order: 5,
            placeholder: "Fast, slow, moderate...",
          },
          mood: {
            tab: "composition",
            order: 6,
            placeholder: "Joyful, melancholic, epic...",
          },
          musicalStyle: {
            tab: "composition",
            order: 7,
            label: "Musical Style",
            placeholder: "Classical, folk, modern...",
          },
          length: {
            tab: "composition",
            order: 8,
            placeholder: "Duration of the piece",
          },
          difficulty: {
            tab: "composition",
            order: 9,
          ...
          variations: {
            tab: "composition",
            order: 10,
            placeholder: "Different versions...",
          },
          ...
          culturalOrigin: {
            ...
            endpoint: "/api/cultures",
            multiple: false,
          },
          occasion: {
            tab: "cultural",
            order: 2,
            placeholder: "When is this performed?",
          },
          significance: {
            tab: "cultural",
            order: 3,
          ...
          popularity: {
            tab: "cultural",
            order: 4,
            placeholder: "How well-known is this?",
          },
        },
      }),

    dance: () =>
      buildConfig(schemas.insertDanceSchema, {
        ...
        fieldHints: {
          ...
          movements: {
            tab: "performance",
            order: 1,
            placeholder: "Key dance movements...",
          },
          formations: {
            tab: "performance",
            order: 2,
            placeholder: "Dance formations (circle, line, etc.)...",
          },
          participants: {
            tab: "performance",
            order: 3,
            placeholder: "Solo, pair, group...",
          },
          music: {
            tab: "performance",
            order: 4,
            endpoint: "/api/music",
            multiple: true,
            placeholder: "Music for this dance...",
          },
          costumes: {
            tab: "performance",
            order: 5,
            rows: 3,
            placeholder: "What do dancers wear?",
          },
          props: {
            tab: "performance",
            order: 6,
            placeholder: "Props used (ribbons, sticks, etc.)...",
          },
          duration: {
            tab: "performance",
            order: 7,
            placeholder: "How long is the dance?",
          },
          difficulty: {
            tab: "performance",
            order: 8,
          ...
          teachingMethods: {
            ...
            rows: 3,
            placeholder: "How is this dance taught?",
          },
          ...
          symbolism: {
            ...
            order: 2,
            rows: 3,
            placeholder: "What does this dance symbolize?",
          },
          ...
          restrictions: {
            tab: "cultural",
            order: 4,
            placeholder: "Who can or cannot perform this?",
          },
          variations: {
            tab: "cultural",
            order: 5,
            placeholder: "Regional variations...",
          },
        },
      }),

    tradition: () =>
      buildConfig(schemas.insertTraditionSchema, {
        ...
        fieldHints: {
          ...
          purpose: {
            ...
            order: 2,
            rows: 3,
            placeholder: "Why is this practiced?",
          },
          participants: {
            tab: "practice",
            order: 3,
          ...
          procedure: {
            ...
            order: 4,
            rows: 4,
            placeholder: "How is this tradition carried out?",
          },
          timing: {
            tab: "practice",
            order: 5,
            placeholder: "When is this practiced?",
          },
          location: {
            tab: "practice",
            order: 6,
            endpoint: "/api/locations",
            multiple: false,
            placeholder: "Where is this practiced?",
          },
          ...
          modernPractice: {
            ...
            rows: 3,
            placeholder: "How is this practiced today?",
          },
          variations: {
            tab: "cultural",
            order: 4,
          ...
          relatedTraditions: {
            tab: "cultural",
            order: 5,
            label: "Related Traditions",
            placeholder: "Similar traditions...",
          },
        },
      }),

    ritual: () =>
      buildConfig(schemas.insertRitualSchema, {
        ...
        fieldHints: {
          ...
          steps: {
            tab: "execution",
            order: 1,
            placeholder: "Ritual steps in order...",
          },
          participants: {
            tab: "execution",
            order: 2,
          ...
          location: {
            ...
            endpoint: "/api/locations",
            multiple: false,
            placeholder: "Where is this performed?",
          },
          timing: {
            tab: "execution",
            order: 5,
            placeholder: "When must this be performed?",
          },
          ...
          components: {
            tab: "requirements",
            order: 2,
            placeholder: "Materials and components...",
          },
          effects: {
            tab: "requirements",
            order: 3,
            rows: 3,
            placeholder: "What happens when performed?",
          },
          risks: {
            tab: "requirements",
            order: 4,
            rows: 3,
            placeholder: "Dangers or risks...",
          },
          variations: {
            tab: "requirements",
            order: 5,
    ...
    myth: () =>
      buildConfig(schemas.insertMythSchema, {
        title: "Myth Creator",
        ...
        fieldHints: {
          ...
          summary: {
            ...
            order: 4,
            rows: 4,
            placeholder: "Brief summary of the myth...",
          },
          genre: { tab: "basic", order: 5 },
          ...
          characters: {
            ...
            endpoint: "/api/characters",
            multiple: true,
            placeholder: "Key characters in the myth...",
          },
          ...
          moralLesson: {
            ...
            label: "Moral Lesson",
            rows: 3,
            placeholder: "What lesson does this teach?",
          },
          ...
          variations: {
            tab: "cultural",
            order: 3,
            placeholder: "Different versions of this myth...",
          },
          modernRelevance: {
            tab: "cultural",
            order: 4,
            ...
            rows: 3,
            placeholder: "How is this relevant today?",
          },
          relatedMyths: {
            tab: "cultural",
            order: 5,
            label: "Related Myths",
            placeholder: "Similar myths...",
          },
        },
      }),

    legend: () =>
      buildConfig(schemas.insertLegendSchema, {
        ...
        fieldHints: {
          ...
          summary: {
            ...
            order: 4,
            rows: 4,
            placeholder: "Brief summary of the legend...",
          },
          genre: { tab: "basic", order: 5 },
          ...
          fullStory: {
            ...
            label: "Full Story",
            rows: 10,
            placeholder: "The complete legend...",
          },
          mainCharacters: {
            tab: "story",
            order: 2,
          ...
          historicalBasis: {
            ...
            rows: 3,
            placeholder: "Real events this is based on...",
          },
          truthElements: {
            tab: "truth",
            order: 2,
            ...
            rows: 3,
            placeholder: "What parts are true?",
          },
          exaggerations: {
            tab: "truth",
            order: 3,
            rows: 3,
            placeholder: "What parts are exaggerated?",
          },
          culturalImpact: {
            tab: "truth",
            order: 4,
            ...
            rows: 3,
            placeholder: "How has this affected culture?",
          },
          modernAdaptations: {
            tab: "truth",
            order: 5,
            label: "Modern Adaptations",
            placeholder: "Modern retellings...",
          },
        },
      }),

    accessory: () =>
      buildConfig(schemas.insertAccessorySchema, {
        ...
        fieldHints: {
          ...
          enchantments: {
            tab: "details",
            order: 6,
            placeholder: "Magical properties...",
          },
    ...
    clothing: () =>
      buildConfig(schemas.insertClothingSchema, {
        ...
        fieldHints: {
          ...
          materials: {
            ...
            endpoint: "/api/materials",
            multiple: true,
            placeholder: "Fabrics and materials...",
          },
          ...
          socialClass: {
            ...
            order: 1,
            label: "Social Class",
            placeholder: "Who wears this?",
          },
          occasion: {
            tab: "cultural",
            order: 2,
            placeholder: "When is it worn?",
          },
          climate: {
            tab: "cultural",
            order: 3,
    ...
    material: () =>
      buildConfig(schemas.insertMaterialSchema, {
        ...
        fieldHints: {
          ...
          processing: {
            ...
            order: 2,
            rows: 3,
            placeholder: "How is it processed?",
          },
          uses: {
            tab: "production",
            order: 3,
    ...
    militaryUnit: () =>
      buildConfig(schemas.insertMilitaryUnitSchema, {
        ...
        fieldHints: {
          ...
          size: {
            tab: "structure",
            order: 1,
            placeholder: "Unit size (number of troops)",
          },
          composition: {
            tab: "structure",
            order: 2,
            rows: 3,
            placeholder: "What is the unit made up of?",
          },
          commander: {
            tab: "structure",
            order: 3,
            endpoint: "/api/characters",
            multiple: false,
            placeholder: "Who commands this unit?",
          },
          equipment: {
            tab: "structure",
            order: 4,
            placeholder: "Weapons and equipment...",
          },
          training: {
            tab: "structure",
            order: 5,
            rows: 3,
            placeholder: "How are they trained?",
          },
          specializations: {
            tab: "structure",
            order: 6,
            placeholder: "Special skills or tactics...",
          },
          ...
          history: {
            ...
            order: 1,
            rows: 4,
            placeholder: "Unit history and formation...",
          },
          battleRecord: {
            tab: "history",
            order: 2,
            label: "Battle Record",
            rows: 3,
            placeholder: "Notable battles and campaigns...",
          },
          reputation: {
            tab: "history",
            order: 3,
            rows: 3,
            placeholder: "How are they perceived?",
          },
          morale: {
            tab: "history",
            order: 4,
            placeholder: "Current morale level",
          },
          currentStatus: {
            tab: "history",
            order: 5,
    ...
    transportation: () =>
      buildConfig(schemas.insertTransportationSchema, {
        ...
        fieldHints: {
          ...
          capacity: {
            tab: "specs",
            order: 1,
            placeholder: "How many people/cargo?",
          },
          speed: {
            tab: "specs",
            order: 2,
            placeholder: "How fast does it go?",
          },
          ...
          requirements: {
            ...
            order: 1,
            rows: 3,
            placeholder: "What is needed to use this?",
          },
          operation: {
            tab: "usage",
            order: 2,
            rows: 3,
            placeholder: "How is it operated?",
          },
          construction: {
            tab: "usage",
            order: 3,
          ...
          advantages: {
            tab: "usage",
            order: 4,
            placeholder: "Benefits of using this...",
          },
          disadvantages: {
            tab: "usage",
            order: 5,
    ...
    naturalLaw: () =>
      buildConfig(schemas.insertNaturalLawSchema, {
        ...
        fieldHints: {
          ...
          scope: {
            ...
            order: 1,
            rows: 3,
            placeholder: "What does this law govern?",
          },
          principles: {
            tab: "principles",
            order: 2,
            rows: 4,
            placeholder: "Core principles and mechanics...",
          },
          exceptions: {
            tab: "principles",
            order: 3,
            placeholder: "Exceptions to the law...",
          },
          evidence: {
            tab: "principles",
            order: 4,
            rows: 3,
            placeholder: "How is this law proven?",
          },
          ...
          applications: {
            tab: "applications",
            order: 2,
            placeholder: "Practical applications...",
          },
          implications: {
            tab: "applications",
            order: 3,
          ...
          relatedLaws: {
            ...
            order: 4,
            label: "Related Laws",
            placeholder: "Connected laws...",
          },
          understanding: {
            tab: "applications",
            order: 5,
            rows: 3,
            placeholder: "How well is it understood?",
          },
          controversies: {
            tab: "applications",
            order: 6,
            rows: 3,
            placeholder: "Debates or disputes...",
          },
        },
      }),

    resource: () =>
      buildConfig(schemas.insertResourceSchema, {
        ...
        fieldHints: {
          ...
          abundance: {
            tab: "properties",
            order: 1,
            placeholder: "How plentiful is it?",
          },
          location: {
            tab: "properties",
            order: 2,
          ...
          extractionMethod: {
            ...
            rows: 3,
            placeholder: "How is it extracted?",
          },
          uses: {
            tab: "properties",
            order: 4,
          ...
          tradeCommodity: {
            ...
            placeholder: "Is it traded? How?",
          },
          controlledBy: {
            tab: "economics",
            order: 2,
            label: "Controlled By",
            placeholder: "Who controls this resource?",
          },
          conflicts: {
            tab: "economics",
            order: 3,
            rows: 3,
            placeholder: "Conflicts over this resource...",
          },
        },
      }),

    animal: () =>
      buildConfig(schemas.insertAnimalSchema, {
        ...
        fieldHints: {
          ...
          domestication: {
            ...
            order: 6,
            rows: 2,
            placeholder: "Can it be domesticated?",
          },
          intelligence: {
            tab: "biology",
            order: 7,
            placeholder: "Intelligence level",
          },
          abilities: {
            tab: "biology",
            order: 8,
          ...
          lifecycle: {
            ...
            order: 9,
            rows: 3,
            placeholder: "Life cycle and reproduction...",
          },
          ...
          culturalRole: {
            ...
            label: "Cultural Role",
            rows: 3,
            placeholder: "Role in society and culture...",
          },
          threats: {
            tab: "culture",
            order: 2,
            placeholder: "Threats to this species...",
          },
        },
      }),

    plant: () =>
      buildConfig(schemas.insertPlantSchema, {
        ...
        fieldHints: {
          ...
          habitat: {
            ...
            order: 2,
            rows: 3,
            placeholder: "Where does it grow?",
          },
          careInstructions: {
            tab: "botany",
            order: 3,
            ...
            rows: 3,
            placeholder: "How to care for it...",
          },
          ...
          hardinessZone: {
            ...
            placeholder: "Growing zones...",
          },
        },
      }),

    settlement: () =>
      buildConfig(schemas.insertSettlementSchema, {
        ...
        tabs: [
          ...
          {
            id: "governance",
            label: "Governance & Economy",
            icon: "Landmark",
            order: 2,
          },
          {
            id: "features",
            label: "Features & Geography",
            icon: "Map",
            order: 3,
          },
        ],
        fieldHints: {
          ...
          economy: {
            ...
            order: 3,
            rows: 3,
            placeholder: "Economic system and trade...",
          },
          culture: {
            tab: "governance",
            order: 4,
          ...
          history: {
            ...
            order: 5,
            rows: 4,
            placeholder: "Settlement history...",
          },
          ...
          defenses: {
            ...
            order: 3,
            rows: 3,
            placeholder: "Defenses and fortifications...",
          },
          resources: {
            tab: "features",
            order: 4,
          ...
          threats: {
            tab: "features",
            order: 5,
            placeholder: "Threats and dangers...",
          },
          landmarks: {
            tab: "features",
            order: 6,
            placeholder: "Notable landmarks...",
          },
          districts: {
            tab: "features",
            order: 7,
            placeholder: "Districts and neighborhoods...",
          },
        },
      }),

    society: () =>
      buildConfig(schemas.insertSocietySchema, {
        ...
        fieldHints: {
          ...
          structure: {
            ...
            order: 1,
            rows: 3,
            placeholder: "Social structure and hierarchy...",
          },
          leadership: {
            tab: "structure",
            order: 2,
            rows: 3,
            placeholder: "Leadership and power structure...",
          },
          laws: {
            tab: "structure",
            order: 3,
          ...
          customs: {
            tab: "structure",
            order: 5,
            placeholder: "Customs and traditions...",
          },
          history: {
            tab: "structure",
            order: 6,
            rows: 4,
            placeholder: "Society history...",
          },
          ...
          religion: {
            ...
            order: 5,
            rows: 3,
            placeholder: "Religious institutions...",
          },
          arts: {
            tab: "institutions",
            order: 6,
            rows: 3,
            placeholder: "Arts and culture...",
          },
        },
      }),

    technology: () =>
      buildConfig(schemas.insertTechnologySchema, {
        ...
        fieldHints: {
          ...
          requirements: {
            tab: "mechanics",
            order: 3,
            placeholder: "Requirements to use...",
          },
          limitations: {
            tab: "mechanics",
            order: 4,
    ...
    event: () =>
      buildConfig(schemas.insertEventSchema, {
        ...
        fieldHints: {
          ...
          scale: {
            tab: "details",
            order: 5,
            placeholder: "Scale of the event",
          },
          causes: {
            tab: "details",
            order: 6,
          ...
          documentation: {
            ...
            order: 4,
            rows: 3,
            placeholder: "How is it documented?",
          },
          conflictingAccounts: {
            tab: "impact",
            order: 5,
            ...
            rows: 3,
            placeholder: "Different versions of the story...",
          },
        },
      }),

    religion: () =>
      buildConfig(schemas.insertReligionSchema, {
        ...
        fieldHints: {
          ...
          deities: {
            tab: "beliefs",
            order: 3,
            placeholder: "Gods, goddesses, or divine beings...",
          },
          morality: {
            tab: "beliefs",
            order: 4,
            rows: 3,
            placeholder: "Moral code and ethics...",
          },
          afterlife: {
            tab: "beliefs",
            order: 5,
            rows: 3,
            placeholder: "Views on afterlife...",
          },
          scriptures: {
            tab: "beliefs",
            order: 6,
            rows: 3,
            placeholder: "Sacred texts and writings...",
          },
          ceremonies: {
            tab: "beliefs",
            order: 7,
            placeholder: "Ceremonies and celebrations...",
          },
          symbols: {
            tab: "beliefs",
            order: 8,
            placeholder: "Religious symbols...",
          },
          ...
          hierarchy: {
            ...
            order: 1,
            rows: 3,
            placeholder: "Religious hierarchy and structure...",
          },
          followers: {
            tab: "organization",
            order: 2,
            placeholder: "Who follows this religion?",
          },
          influence: {
            tab: "organization",
            order: 3,
            rows: 3,
            placeholder: "Influence on society...",
          },
          history: {
            tab: "organization",
            order: 4,
    ...
    language: () =>
      buildConfig(schemas.insertLanguageSchema, {
        ...
        fieldHints: {
          ...
          status: {
            tab: "basic",
            order: 3,
            placeholder: "Living, dead, constructed, etc.",
          },
          speakers: {
            tab: "basic",
            order: 4,
          ...
          regions: {
            tab: "basic",
            order: 5,
            placeholder: "Regions where spoken...",
          },
          genre: { tab: "basic", order: 6 },
          ...
          grammar: {
            ...
            order: 2,
            rows: 3,
            placeholder: "Grammatical structure...",
          },
          vocabulary: {
            tab: "linguistics",
            order: 3,
            rows: 3,
            placeholder: "Vocabulary and word formation...",
          },
          writingSystem: {
            tab: "linguistics",
            order: 4,
          ...
          commonPhrases: {
            ...
            placeholder: "Common phrases and expressions...",
          },
          variations: {
            tab: "linguistics",
            order: 6,
            placeholder: "Dialects and variations...",
          },
          difficulty: {
            tab: "linguistics",
            order: 7,
            placeholder: "Learning difficulty",
          },
          ...
          history: {
            ...
            order: 2,
            rows: 4,
            placeholder: "Language history and evolution...",
          },
        },
      }),

    faction: () =>
      buildConfig(schemas.insertFactionSchema, {
        ...
        fieldHints: {
          ...
          ideology: {
            ...
            order: 2,
            rows: 3,
            placeholder: "Ideology and beliefs...",
          },
          leadership: {
            tab: "identity",
            order: 3,
          ...
          methods: {
            ...
            order: 5,
            rows: 3,
            placeholder: "Methods and tactics...",
          },
          secrets: {
            tab: "identity",
            order: 6,
            rows: 3,
            placeholder: "Hidden agendas and secrets...",
          },
          ...
          territory: {
            ...
            order: 2,
            rows: 3,
            placeholder: "Controlled territory...",
          },
          influence: {
            tab: "power",
            order: 3,
            rows: 3,
            placeholder: "Sphere of influence...",
          },
    ...
    weapon: () =>
      buildConfig(schemas.insertWeaponSchema, {
        ...
        fieldHints: {
          ...
          weaponType: {
            ...
            order: 2,
            label: "Type",
            placeholder: "Sword, bow, staff, etc.",
          },
          description: { tab: "basic", order: 3, rows: 4 },
          genre: { tab: "basic", order: 4 },
          ...
          craftsmanship: {
            ...
            order: 5,
            rows: 3,
            placeholder: "Quality and craftsmanship...",
          },
          enchantments: {
            tab: "properties",
            order: 6,
            placeholder: "Magical enhancements...",
          },
          rarity: {
            tab: "properties",
            order: 7,
            placeholder: "Common, rare, legendary, etc.",
          },
          ...
          history: {
            ...
            order: 1,
            rows: 4,
            placeholder: "History and origin...",
          },
          ...
          articleContent: {
            ...
            rows: 6,
            placeholder: "Rich content for article format...",
          },
        },
      }),

    building: () =>
      buildConfig(schemas.insertBuildingSchema, {
        ...
        fieldHints: {
          ...
          buildingType: {
            ...
            order: 2,
            label: "Type",
            placeholder: "Temple, castle, shop, house, etc.",
          },
          description: { tab: "basic", order: 3, rows: 4 },
          genre: { tab: "basic", order: 4 },
          ...
          defenses: {
            ...
            order: 5,
            rows: 2,
            placeholder: "Defensive features...",
          },
          currentCondition: {
            tab: "details",
            order: 6,
    ...
    creature: () =>
      buildConfig(schemas.insertCreatureSchema, {
        ...
        fieldHints: {
          ...
          culturalSignificance: {
            ...
            label: "Cultural Significance",
            rows: 4,
            placeholder: "Significance in culture...",
          },
          imageUrl: { tab: "basic", order: 1, label: "Image URL" },
          imageCaption: { tab: "lore", order: 3, label: "Image Caption" },
          articleContent: {
    ...
    item: () =>
      buildConfig(schemas.insertItemSchema, {
        title: "Item Designer",
        ...
        fieldHints: {
          ...
          itemType: {
            ...
            order: 2,
            label: "Type",
            placeholder: "Weapon, armor, tool, magic, etc.",
          },
          description: { tab: "basic", order: 3, rows: 4 },
          genre: { tab: "basic", order: 4 },
    ...
    location: () =>
      buildConfig(schemas.insertLocationSchema, {
        ...
        fieldHints: {
          ...
          threats: {
            tab: "details",
            order: 6,
            placeholder: "Dangers and threats...",
          },
    ...
    organization: () =>
      buildConfig(schemas.insertOrganizationSchema, {
        ...
        fieldHints: {
          ...
          organizationType: {
            ...
            order: 2,
            label: "Type",
            placeholder: "Guild, faction, government, etc.",
          },
          ...
          leadership: {
            ...
            order: 2,
            rows: 3,
            placeholder: "Leadership hierarchy...",
          },
          members: {
            tab: "structure",
            order: 3,
          ...
          allies: {
            tab: "influence",
            order: 4,
            placeholder: "Allied organizations...",
          },
          enemies: {
            tab: "influence",
            order: 5,
            placeholder: "Enemy organizations...",
          },
          history: {
            tab: "influence",
            order: 6,
            rows: 4,
            placeholder: "Organizational history...",
          },
          imageUrl: { tab: "basic", order: 1, label: "Image URL" },
    ...
    conflict: () =>
      buildConfig(schemas.insertConflictSchema, {
        ...
        fieldHints: {
          ...
          type: {
            tab: "basic",
            order: 2,
            placeholder: "Internal, external, interpersonal, etc.",
          },
          description: { tab: "basic", order: 3, rows: 4 },
          genre: { tab: "basic", order: 4 },
          ...
          potentialResolutions: {
            tab: "details",
            order: 3,
            label: "Potential Resolutions",
            placeholder: "Possible resolutions...",
          },
          emotionalImpact: {
            tab: "details",
            order: 4,
            ...
            rows: 3,
            placeholder: "Emotional impact on characters...",
          },
          imageUrl: { tab: "basic", order: 1, label: "Image URL" },
    ...
    theme: () =>
      buildConfig(schemas.insertThemeSchema, {
        ...
        fieldHints: {
          ...
          coreMessage: {
            ...
            label: "Core Message",
            rows: 3,
            placeholder: "Central message or idea...",
          },
          genre: { tab: "basic", order: 4 },
          ...
          questions: {
            tab: "elements",
            order: 2,
            placeholder: "Questions raised...",
          },
          conflicts: {
            tab: "elements",
            order: 3,
            placeholder: "Related conflicts...",
          },
          examples: {
            tab: "elements",
            order: 4,
            placeholder: "Examples in story...",
          },
          imageUrl: { tab: "basic", order: 1, label: "Image URL" },
    ...
    mood: () =>
      buildConfig(schemas.insertMoodSchema, {
        title: "Mood Designer",
        ...
        fieldHints: {
          ...
          emotionalTone: {
            ...
            rows: 3,
            placeholder: "Emotional tone and feeling...",
          },
          ...
          colorAssociations: {
            ...
            placeholder: "Associated colors...",
          },
          weatherElements: {
            tab: "sensory",
            order: 3,
            label: "Weather Elements",
            placeholder: "Weather elements...",
          },
          lightingEffects: {
            tab: "sensory",
            order: 4,
            label: "Lighting Effects",
            placeholder: "Lighting effects...",
          },
          soundscape: {
            tab: "sensory",
            order: 5,
            placeholder: "Sounds and ambient noise...",
          },
        },
      }),

    description: () =>
      buildConfig(schemas.insertDescriptionSchema, {
        title: "Description Generator",
        description: "Generate vivid descriptions",
        icon: "FileText",
        defaultTab: "basic",
        tabs: [{ id: "basic", label: "Details", icon: "FileText", order: 1 }],
        fieldHints: {
          title: { tab: "basic", order: 2 },
          ...
          descriptionType: {
            ...
            order: 3,
            label: "Type",
            placeholder: "Armor, weapon, clothing, etc.",
          },
          genre: { tab: "basic", order: 4 },
    ...
    name: () =>
      buildConfig(schemas.insertNameSchema, {
        ...
        fieldHints: {
          ...
          meaning: {
            ...
            order: 2,
            rows: 2,
            placeholder: "What does the name mean?",
          },
          origin: {
            tab: "basic",
            order: 3,
            rows: 2,
            placeholder: "Origin of the name",
          },
          nameType: {
            tab: "basic",
            order: 4,
            label: "Type",
            placeholder: "Character, place, fantasy, etc.",
          },
          culture: {
            tab: "basic",
            order: 5,
    ...
    map: () =>
      buildConfig(schemas.insertMapSchema, {
        title: "Map Designer",
        ...
        fieldHints: {
          ...
          mapType: {
            ...
            order: 2,
            label: "Type",
            placeholder: "World, regional, city, dungeon, political, etc.",
          },
          description: { tab: "basic", order: 3, rows: 4 },
          genre: { tab: "basic", order: 4 },
          ...
          scale: {
            tab: "geography",
            order: 1,
            placeholder: "Global, continental, regional, local, etc.",
          },
          dimensions: {
            tab: "geography",
            order: 2,
          ...
          hiddenFeatures: {
            ...
            placeholder: "Secret or hidden features...",
          },
          legends: {
            tab: "features",
            order: 8,
            placeholder: "Map legends and symbols...",
          },
          mapMaker: {
            tab: "features",
            order: 9,
            label: "Map Maker",
            placeholder: "Who created this map?",
          },
          accuracy: {
            tab: "features",
            order: 10,
            placeholder: "Precise, rough, outdated, etc.",
          },
        },
      }),

    setting: () =>
      buildConfig(schemas.insertSettingSchema, {
    ...
    armor: () =>
      buildConfig(schemas.insertArmorSchema, {
        ...
        fieldHints: {
          ...
          coverage: {
            ...
            order: 4,
            rows: 2,
            placeholder: "Body coverage...",
          },
          mobility: {
            tab: "properties",
            order: 5,
            rows: 2,
            placeholder: "Impact on mobility...",
          },
          enchantments: {
            tab: "properties",
            order: 6,
    ...
    spell: () =>
      buildConfig(schemas.insertSpellSchema, {
        ...
        fieldHints: {
          ...
          school: {
            tab: "basic",
            order: 2,
            placeholder: "Evocation, divination, etc.",
          },
          ...
          limitations: {
            ...
            order: 6,
            rows: 2,
            placeholder: "Limitations and restrictions...",
          },
          ...
          origin: {
            ...
            order: 1,
            rows: 3,
            placeholder: "Origin of the spell...",
          },
          variations: {
            tab: "lore",
            order: 2,
            placeholder: "Spell variations...",
          },
          risks: {
            tab: "lore",
            order: 3,
    ...
    plot: () =>
      buildConfig(schemas.insertPlotSchema, {
        ...
        fieldHints: {
          ...
          storyStructure: {
            ...
            order: 4,
            label: "Story Structure",
            placeholder: "Three-act, hero's journey, etc.",
          },
        },
      }),

    familyTree: () =>
      buildConfig(schemas.insertFamilyTreeSchema, {
        ...
        fieldHints: {
          ...
          zoom: {
            tab: "basic",
            order: 4,
            placeholder: "Zoom level (default: 1)",
          },
          panX: {
            tab: "basic",
            order: 5,
            label: "Pan X",
            placeholder: "Horizontal pan position",
          },
          panY: {
            tab: "basic",
            order: 6,
            label: "Pan Y",
            placeholder: "Vertical pan position",
          },
        },
      }),

    timeline: () =>
      buildConfig(schemas.insertTimelineSchema, {
        ...
        fieldHints: {
          ...
          timelineType: {
            ...
            order: 3,
            label: "Type",
            placeholder: "Historical, character, world, campaign, etc.",
          },
          timeScale: {
            tab: "basic",
            order: 4,
            label: "Time Scale",
            placeholder: "Years, decades, centuries, millennia, etc.",
          },
          scope: {
            tab: "basic",
            order: 5,
            placeholder: "Global, regional, local, personal, etc.",
          },
          genre: { tab: "basic", order: 6 },
          ...
          keyFigures: {
            ...
            order: 4,
            label: "Key Figures",
            placeholder: "Important figures...",
          },
          culturalPeriods: {
            tab: "events",
            order: 5,
            label: "Cultural Periods",
            placeholder: "Cultural periods...",
          },
          wars: {
            tab: "events",
            order: 6,
            placeholder: "Wars and conflicts...",
          },
          naturalDisasters: {
            tab: "events",
            order: 7,
          ...
          discoveries: {
            tab: "changes",
            order: 1,
            placeholder: "Major discoveries...",
          },
          politicalChanges: {
            tab: "changes",
            order: 2,
            label: "Political Changes",
            placeholder: "Political changes...",
          },
          technologicalAdvances: {
            tab: "changes",
            order: 3,
            label: "Technological Advances",
            placeholder: "Technological advances...",
          },
        },
      }),

    prompt: () =>
      buildConfig(schemas.insertPromptSchema, {
 ...
 */
export function getSchemaDrivenConfig(
  contentType: string,
