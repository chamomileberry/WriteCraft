...
export const FEATURE_DESCRIPTIONS: Record<string, FeatureDescription> = {
  ...
  prioritySupport: {
    title: 'Support',
    description: 'Access help documentation, guides, and AI-powered chat assistance. Higher tiers receive faster response times for support inquiries.',
    comparison: {
  ...
  exportFormats: {
    ...
    description: 'Export your work in various formats for publishing, editing, or sharing. All paid tiers include TXT, DOCX, PDF, and HTML export.',
    comparison: {
      free: 'TXT, DOCX',
