      ...
      <AlertDialogContent data-testid="dialog-limit-exceeded">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription
            ...
            data-testid="text-dialog-description"
          >
            ...
            {gracePeriodExpired ? (
              <div className="p-3 bg-destructive/10 border border-destructive rounded-md">
                ...
                <p className="text-sm text-destructive/90 mt-1">
                  ...
                  reduce your usage to continue using this feature.
                </p>
              </div>
            ) : daysRemaining !== null ? (
              <div className="p-3 bg-orange-50 dark:bg-orange-950/30 border border-orange-200 dark:border-orange-800 rounded-md">
                <p className="font-semibold text-sm text-orange-800 dark:text-orange-300">
                  Grace Period: {daysRemaining}{" "}
                  {daysRemaining === 1 ? "day" : "days"} remaining
                </p>
                <p className="text-sm text-orange-700 dark:text-orange-400 mt-1">
                  You can still create new{" "}
                  {limitType === "projects"
                    ? "projects"
                    : limitType === "notebooks"
                      ? "notebooks"
                      : "AI generations"}{" "}
                  during the grace period, but please upgrade soon to avoid
                  service interruption.
                </p>
              </div>
            ) : (
              <p className="text-sm text-muted-foreground">
                Upgrade to a higher tier to get more{" "}
                {limitType === "projects"
                  ? "projects"
                  : limitType === "notebooks"
                    ? "notebooks"
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction
            ...
            className={
              gracePeriodExpired ? "bg-destructive hover:bg-destructive/90" : ""
            }
