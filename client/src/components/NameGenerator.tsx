...
export default function NameGenerator() {
  ...
  const getAllEthnicities = () => {
    return Object.entries(ETHNICITY_CATEGORIES).flatMap(
      ([category, ethnicities]) =>
        ethnicities.map((ethnicity) => ({
          value: ethnicity.toLowerCase().replace(/[^a-z0-9]/g, "_"),
          label: ethnicity,
          category,
        })),
    );
  ...
  const getEthnicityCategorizedOptions = () => {
    ...
    Object.entries(ETHNICITY_CATEGORIES).forEach(([category, ethnicities]) => {
      result[category] = ethnicities.map((ethnicity) =>
        ethnicity.toLowerCase().replace(/[^a-z0-9]/g, "_"),
      );
    });
    return result;
  };
  ...
  const getNameTypeLabel = () => {
    ...
    return (
      allTypes.find((type) => type.value === nameType)?.label ||
      "Select name type"
    );
  };
  ...
  const getCultureLabel = () => {
    ...
    return (
      allEthnicities.find((eth) => eth.value === culture)?.label ||
      "Any culture"
    );
  };
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            Generate culturally appropriate names with meanings.
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <div>
                ...
                <SearchableSelect
                  ...
                  formatLabel={(value) => {
                    const allTypes = getAllNameTypes();
                    return (
                      allTypes.find((type) => type.value === value)?.label ||
                      value
                    );
                  }}
                />
              ...
              <div>
                ...
                <SearchableSelect
                  ...
                  formatLabel={(value) => {
                    ...
                    const allEthnicities = getAllEthnicities();
                    return (
                      allEthnicities.find((eth) => eth.value === value)
                        ?.label || value
                    );
                  }}
                />
                    ...
                    <div className="flex-1">
                      ...
                      {name.meaning && (
                        <p
                          ...
                          data-testid={`text-meaning-${index}`}
                        >
        ...
        <Card className="text-center py-12">
          <CardContent>
            ...
            <p className="text-muted-foreground">
              Choose your options above and click generate to create perfect
              names for your story
            </p>
          </CardContent>
        </Card>
      )}
