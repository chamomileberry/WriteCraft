...
const DESCRIPTION_TYPE_CATEGORIES = {
  ...
  "Environment & Atmosphere": ["atmospheric", "climate", "weather", "storm"],
  "Culture & Society": [
    "holiday",
    "tradition",
    "ritual",
  ...
  "Combat & Skills": ["martial_art", "spell"],
  ...
  "Mystical & Prophetic": ["prophecy"],
  "Food & Consumables": ["food", "drink"],
...
export default function DescriptionGenerator() {
  ...
  const { notebookId, validateNotebook } = useRequireNotebook({
    errorMessage:
      "Please create or select a notebook before generating descriptions.",
  });
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
                ...
                <CardDescription className="mt-2 text-base">
                  <div className="flex flex-wrap gap-2 mt-2">
                    <Badge variant="outline">
                      {generatedDescription.descriptionType}
                    </Badge>
      ...
      <UpgradePrompt
        ...
        description="You've reached your daily AI generation limit. Upgrade to a paid plan for unlimited description generation."
        feature="AI description generations"
      />
    </div>
  );
}
