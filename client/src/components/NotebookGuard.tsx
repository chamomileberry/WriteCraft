...
export function NotebookGuard({ 
  ...
  if (minimal) {
    return (
      <div className="bg-muted/50 border border-dashed rounded-lg p-6 text-center" data-testid="notebook-guard-banner">
  ...
  return (
    <div className="flex items-center justify-center min-h-[400px] p-4" data-testid="notebook-guard">
