  ...
  (
    ...
    const autosave = useAutosave({
      ...
      onSuccess: () => {
        ...
        queryClient.invalidateQueries({
          queryKey: ["/api/projects", projectId, "sections", section.id],
        });
      },
      onError: (error: any) => {
        onSaveStatusChange?.("unsaved");
    ...
    return (
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {readOnly && (
          <div
            className="bg-muted/50 border-b px-4 py-2 text-sm text-muted-foreground"
            data-testid="banner-readonly"
          >
            <span>
              This project is shared with you as read-only. You cannot make
              edits.
            </span>
          </div>
        )}
