  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        data-testid="dialog-relationship-selector"
      >
        <DialogHeader>
          <DialogTitle>Add Relationship</DialogTitle>
          <DialogDescription>
            Define how <span className="font-medium">{sourceNodeLabel}</span> is
            related to <span className="font-medium">{targetNodeLabel}</span>
          </DialogDescription>
        </DialogHeader>
