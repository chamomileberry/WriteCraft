...
export function ActivityLogSidebar({ projectId, onClose }: ActivityLogSidebarProps) {
  ...
  return (
    <div className="fixed right-0 top-0 h-full w-96 bg-card border-l border-border shadow-lg z-50 flex flex-col" data-testid="activity-log-sidebar">
      {/* Header */}
                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <div className="flex items-center gap-1 text-muted-foreground">
                        ...
                        <span className="text-xs capitalize">{activity.activityType}</span>
                      </div>
                    </div>
                  </div>
