...
export default function Hero({ onGetStarted, onNavigate }: HeroProps) {
  const handleGetStarted = () => {
    ...
    if (onGetStarted) {
      ...
      console.log(
        "No callback or navigation provided, using fallback redirect",
      );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            Discover powerful writing tools, generators, and comprehensive
            guides designed to inspire and support your creative writing
            journey. From character creation to plot development, find
