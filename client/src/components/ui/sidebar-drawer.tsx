  ...
  return (
    <>
      ...
      <div
        ref={ref}
        className={cn(
          "fixed top-0 left-0 z-[var(--z-modal)] h-full w-80 max-w-[85vw] bg-background border-r border-border shadow-lg transform transition-transform duration-300 ease-in-out",
          className
        )}
        {...props}
