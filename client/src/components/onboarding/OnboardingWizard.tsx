...
export function OnboardingWizard({ isOpen, onClose, userId }: OnboardingWizardProps) {
  const [step, setStep] = useState<'welcome' | 'experienced-tour' | 'new-tutorial'>('welcome');
      ...
      >
        <DialogHeader>
          <div className="flex items-center gap-2 mb-2">
            ...
            <DialogTitle className="text-2xl">Welcome to WriteCraft!</DialogTitle>
          </div>
        ...
        <div className="space-y-6 py-4">
          <p className="text-muted-foreground">
            WriteCraft helps you create rich, detailed worlds for your stories with AI-powered generators, 
            organizational tools, and writing guides. Let's get you started!
          </p>

          <div className="space-y-3">
            <h3 className="font-semibold text-lg">How would you describe yourself?</h3>
            
            <div className="grid gap-4 md:grid-cols-2">
              <Card 
                className="cursor-pointer hover-elevate active-elevate-2 transition-all"
                onClick={() => handleExperienceSelection('new_to_worldbuilding')}
                data-testid="card-experience-new"
              >
                <CardHeader className="gap-2">
                  <div className="flex items-center gap-2">
                    <BookOpen className="w-5 h-5 text-primary" />
                    <CardTitle className="text-lg">New to Worldbuilding</CardTitle>
                  </div>
                  <CardDescription>
                    I'm just getting started with creating fictional worlds and need guidance
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    We'll guide you through creating your first character step-by-step
                  </p>
                </CardContent>
              </Card>
              ...
              <Card 
                className="cursor-pointer hover-elevate active-elevate-2 transition-all"
                onClick={() => handleExperienceSelection('experienced_worldbuilder')}
                data-testid="card-experience-experienced"
              >
                <CardHeader className="gap-2">
                  <div className="flex items-center gap-2">
                    <Rocket className="w-5 h-5 text-primary" />
                    <CardTitle className="text-lg">Experienced Worldbuilder</CardTitle>
                  </div>
                  <CardDescription>
                    I've built worlds before and just want a quick tour of the features
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-muted-foreground">
