...
export function ProjectViewer({
  ...
  const { data: selectedSection } = useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await apiRequest(
        "GET",
        `/api/projects/${projectId}/sections/${selectedSectionId}`,
      );
      return response.json();
    },
          ...
          <div className="flex items-center justify-between px-4 py-3">
            ...
            <div className="flex items-center gap-3 flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 min-w-0 text-sm">
                ...
                <span
                  ...
                  data-testid="text-viewer-project-title"
                >
            ...
            <div className="flex items-center gap-4 flex-shrink-0">
              ...
              <div
                ...
                data-testid="text-viewer-word-count"
              >
          ...
          {selectedSection ? (
                ...
                dangerouslySetInnerHTML={{
                  __html: sanitizeHtml(
                    selectedSection.content ||
                      '<p class="text-muted-foreground italic">This section has no content yet.</p>',
                  ),
                }}
            ...
            <div className="flex-1 flex items-center justify-center text-center p-8">
              <div>
                ...
                <Button
                  onClick={onEdit}
                  data-testid="button-start-editing-empty"
                >
                  <Edit className="h-4 w-4 mr-2" />
                  Start Editing
                </Button>
