  ...
  tabs: [
    {
      ...
      fields: [
        ...
        { name: "description", label: "General Description", type: "textarea", placeholder: "A brief overview of this character...", description: "A general description that appears on the character card in your notebook", rows: 4 },
        { name: "physicalCondition", label: "Character Description", type: "textarea", placeholder: "Detailed character description...", description: "Comprehensive character description including personality, traits, and defining characteristics", rows: 6 },
    ...
    },
    {
      ...
      icon: "Smile",
      fields: [
        { name: "facialFeatures", label: "Facial Features", type: "textarea", placeholder: "Sharp jawline, round face, high cheekbones, etc.", description: "Overall facial structure and detailed features" },
    ...
    },
    {
      ...
      icon: "AlertTriangle",
      fields: [
        { name: "characterFlaws", label: "Character Flaws & Defects", type: "textarea", placeholder: "Major personality flaws and deep-seated defects", description: "Significant character flaws, weaknesses, and fundamental defects" },
