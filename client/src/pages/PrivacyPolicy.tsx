      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="space-y-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-4 text-sm">
              <p>
                WriteCraft ("we," "us," "our," or "Company") operates the
                WriteCraft application and website (the "Service"). This Privacy
                Policy explains our data collection, use, and disclosure
                practices.
              </p>
              <p>
                Please read this Privacy Policy carefully. By accessing or using
                WriteCraft, you acknowledge that you have read, understood, and
                agree to be bound by all the provisions of this Privacy Policy.
              </p>
              <p>
            ...
            <CardContent className="space-y-6 text-sm">
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  username, password (hashed), and profile information you
                  choose to provide (display name, avatar, bio).
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  All content you create in WriteCraft (characters, projects,
                  guides, notes, worldbuilding elements, etc.) is stored on our
                  servers.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Payment information is processed directly by Stripe (payment
                  processor). We receive confirmation of successful payments and
                  billing status but never store complete credit card
                  information. We store billing address, email, and subscription
                  details.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  If you contact us (support, feedback, bug reports), we store
                  your message, email, and any attachments.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-muted-foreground space-y-1">
                  <li>
                    <strong>Necessary Cookies:</strong> Essential for
          ...
          <Card>
            ...
            <CardContent className="space-y-6 text-sm">
              <p className="text-muted-foreground">
                WriteCraft uses third-party services that may collect
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Payment information is processed by Stripe. Please review
                  their
                  <a
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  We use AI services for features like character generation,
                  writing prompts, and content suggestions. Please review their
                  privacy policies. We transmit minimal data necessary for these
                  features.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Images you generate and upload may be stored on Google Cloud
                  Storage. Please review their
                  <a
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  We may collect usage analytics to improve the Service. No
                  personal data is transmitted to analytics providers beyond
                  hashed identifiers.
                </p>
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-6 text-sm">
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-muted-foreground space-y-1">
                  <li>
                    <strong>Immediate deletion:</strong> Your account, profile,
                    and all creative content (characters, projects, notebooks,
                    etc.) are permanently deleted within 30 days
                  </li>
                  <li>
                    <strong>Backup retention:</strong> Data may persist in
                    backups for up to 90 days before permanent removal
                  </li>
                  <li>
                    <strong>Before deletion:</strong> You can export all your
                    data in JSON format
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-2">
                  Some data may be retained longer for legal, regulatory, or
                  security purposes:
                </p>
                <ul className="list-disc list-inside text-muted-foreground space-y-1">
                  <li>
                    <strong>Financial records:</strong> Billing and payment
                    records retained for 7 years (tax compliance)
                  </li>
                  <li>
                    <strong>Security logs:</strong> IP addresses and security
                    event logs retained for 1 year (fraud prevention)
                  </li>
                  <li>
                    <strong>Support communications:</strong> Retained for 3
                    years (customer service quality)
                  </li>
                  <li>
                    <strong>Legal holds:</strong> Data may be retained if
                    subject to litigation, subpoena, or legal investigation
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Accounts inactive for 3+ years (no login, no active
                  subscription) may be deleted after email notification. Free
                  tier accounts are retained indefinitely unless deleted by the
                  user.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Anonymized analytics data may be retained indefinitely for
                  product improvement. This data cannot be linked back to
                  individual users after anonymization.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4 text-sm">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                ...
                <li>
                  <strong>Opt-Out:</strong> Opt-out of certain data uses
                </li>
              </ul>
              <p className="text-muted-foreground mt-4">
                To exercise these rights, contact us at support@writecraft.app
                with your request.
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-6 text-sm">
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-muted-foreground space-y-1">
                  <li>
                    ...
                    the Service under our Terms of Service
                  </li>
                  <li>
                    <strong>Consent:</strong> For analytics and optional
                    features (you can withdraw consent anytime)
                  </li>
                  <li>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  place, such as Standard Contractual Clauses (SCCs) approved by
            ...
            <CardContent className="space-y-6 text-sm">
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-muted-foreground space-y-1">
                  ...
                  <li>
                    Professional or employment-related information (if you
                    provide it)
                  </li>
                  <li>
                    User-generated content (creative writing, characters,
                    projects)
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-muted-foreground space-y-1">
                  ...
                  <li>
                    <strong>Right to limit:</strong> Limit use of sensitive
                    personal information
                  </li>
                  <li>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  WriteCraft does not sell your personal information to third
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  privacy@writecraft.app or use the data export/deletion
                  features in your account settings. We will respond within 45
                  days.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  behalf. We require written authorization and verification of
          ...
          <Card>
            ...
            <CardContent className="space-y-4 text-sm">
              <p className="text-muted-foreground">
                WriteCraft is not intended for children under 13 years old. We
                do not knowingly collect personal information from children
                under 13. If we become aware of such collection, we will delete
                the information and terminate the child's account.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4 text-sm">
              <p className="text-muted-foreground">
                ...
                Your continued use of WriteCraft after changes constitutes
        ...
        <div className="mt-12 pt-8 border-t">
          <p className="text-xs text-muted-foreground">
            © {currentYear} WriteCraft. All rights reserved. This Privacy
            Policy is provided as-is for the beta phase of WriteCraft.
          </p>
        </div>
      </div>
    </div>
